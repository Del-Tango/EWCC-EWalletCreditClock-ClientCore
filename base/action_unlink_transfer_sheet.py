...
config_file.remove(config_file[-1])
file_path = '/'.join(item for item in config_file) + '/conf/ewcc.conf'
...
class UnlinkTransferSheet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(UnlinkTransferSheet, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'list_id': '<transfer-sheet type-int>',
        }
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(UnlinkTransferSheet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(UnlinkTransferSheet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(UnlinkTransferSheet, self).set_values(
