...
class TestEwalletClientExecuteActionMasterViewLoginRecords(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'MasterViewLogin', 'MasterUnlinkAccount'
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_master_view_login_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action MasterViewLogin -')
        execute = self.core.execute('MasterViewLogin')
        print(
            "[ I ]: core.execute('MasterViewLogin') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
