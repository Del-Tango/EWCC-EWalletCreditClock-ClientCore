...
class TestEwalletClientExecuteActionCreateContactList(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateContactList',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_contact_list_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateContactList -')
        execute = self.core.execute('CreateContactList')
        print(
            "[ I ]: core.execute('CreateContactList') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
