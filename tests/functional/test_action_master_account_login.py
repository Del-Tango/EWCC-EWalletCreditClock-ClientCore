...
class TestEwalletClientExecuteActionMasterAccountLogin(unittest.TestCase):
...
#       cls.core.execute('UnlinkAccount')
    ...
    def test_ewcc_set_core_execute_action_master_account_login_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action MasterAccountLogin -')
        execute = self.core.execute('MasterAccountLogin')
        print(
            "[ I ]: core.execute('MasterAccountLogin') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
