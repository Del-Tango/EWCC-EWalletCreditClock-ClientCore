...
class TestEwalletClientExecuteActionCreateInvoiceSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateInvoiceSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_invoice_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateInvoiceSheet -')
        execute = self.core.execute('CreateInvoiceSheet')
        print(
            "[ I ]: core.execute('CreateInvoiceSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
