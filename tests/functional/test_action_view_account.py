...
class TestEwalletClientExecuteActionViewAccount(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewAccount', 'CreateMaster',
    ...
    def test_ewcc_set_core_execute_action_view_account_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewAccount -')
        execute = self.core.execute('ViewAccount')
        print(
            "[ I ]: core.execute('ViewAccount') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
