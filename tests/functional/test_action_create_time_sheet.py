...
class TestEwalletClientExecuteActionCreateTimeSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateTimeSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_time_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateTimeSheet -')
        execute = self.core.execute('CreateTimeSheet')
        print(
            "[ I ]: core.execute('CreateTimeSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
