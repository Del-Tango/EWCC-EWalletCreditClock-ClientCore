...
class TestEwalletClientExecuteActionViewLogoutRecords(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewLogoutRecords',
                'CreateMaster', 'AcquireMaster', 'MasterAccountLogin',
                'MasterUnlinkAccount', 'AccountLogout',
            ]
        )
        ...
        account_login1 = cls.core.execute('AccountLogin')
        ...
        print('[...]: Subroutine Execute AccountLogout')
        account_logout = cls.core.execute('AccountLogout')

        print('[...]: Subroutine Execute AccountLogin (2)')
        account_login2 = cls.core.execute('AccountLogin')
    ...
    def test_ewcc_set_core_execute_action_view_logout_records_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewLogoutRecords -')
        execute = self.core.execute('ViewLogoutRecords')
        print(
            "[ I ]: core.execute('ViewLogoutRecords') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
