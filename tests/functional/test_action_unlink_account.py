...
class TestEwalletClientExecuteActionUnlinkAccount(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateMaster',
    ...
    def test_ewcc_set_core_execute_action_unlink_account_functional(self):
        ...
        execute = self.core.execute('UnlinkAccount')
        print(
            "[ I ]: core.execute('UnlinkAccount') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
