...
#   @pysnooper.snoop()
    def setUpClass(cls):
        ...
        print('[...]: Subroutine Execute CreateAccount (1)')
        create_account1 = cls.core.execute('CreateAccount')
        ...
        print('[...]: Subroutine Execute CreateAccount (2)')
        create_account2 = cls.core.execute('CreateAccount')
