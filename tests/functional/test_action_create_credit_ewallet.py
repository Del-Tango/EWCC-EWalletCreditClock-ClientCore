...
class TestEwalletClientExecuteActionCreateCreditEWallet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateCreditEWallet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_credit_ewallet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateCreditEWallet -')
        execute = self.core.execute('CreateCreditEWallet')
        print(
            "[ I ]: core.execute('CreateCreditEWallet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
