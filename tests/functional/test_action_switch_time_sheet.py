    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'ViewCreditClock', 'CreateMaster', 'AcquireMaster',
        ...
        print('[...]: Subroutine Set ResourceInstruction')
        view_clock = cls.core.set_values(
            'ViewCreditClock',
            **{
                'client_id': cls.client_id.get('client_id'),
                'session_token': cls.session_token.get('session_token'),
        ...
        cls.current_time_sheet = int() if not clock_data else \
                cls.response['clock_data']['time_sheet']
        cls.new_time_sheet = int() if not clock_data else int(
            list(
