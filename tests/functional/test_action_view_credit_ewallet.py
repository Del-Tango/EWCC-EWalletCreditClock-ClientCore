...
class TestEwalletClientExecuteActionViewCreditEWallet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewCreditEWallet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_view_credit_ewallet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewCreditEWallet -')
        execute = self.core.execute('ViewCreditEWallet')
        print(
            "[ I ]: core.execute('ViewCreditEWallet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
