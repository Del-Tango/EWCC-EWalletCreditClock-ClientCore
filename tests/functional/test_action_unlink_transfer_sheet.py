...
class TestEwalletClientExecuteActionUnlinkTransferSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'ViewCreditEWallet', 'CreateTransferSheet', 'CreateMaster',
                'SwitchTransferSheet', 'AcquireMaster', 'MasterAccountLogin',
                'MasterUnlinkAccount',
            ]
        )
        ...
        cls.transfer_sheet = int() if not ewallet_data else \
    ...
    def tearDownClass(cls):
        ...
        create_sheet = cls.core.execute('CreateTransferSheet')
    ...
    def test_ewcc_set_core_execute_action_unlink_transfer_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action UnlinkTransferSheet -')
        execute = self.core.execute('UnlinkTransferSheet')
        print(
            "[ I ]: core.execute('UnlinkTransferSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
