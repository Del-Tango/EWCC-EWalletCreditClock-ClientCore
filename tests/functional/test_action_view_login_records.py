...
class TestEwalletClientExecuteActionViewLoginRecords(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewLoginRecords',
    ...
    def test_ewcc_set_core_execute_action_view_login_records_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewLoginRecords -')
        execute = self.core.execute('ViewLoginRecords')
        print(
            "[ I ]: core.execute('ViewLoginRecords') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
        ...
        self.assertTrue(isinstance(execute.get('login_records'), dict))
        return execute
