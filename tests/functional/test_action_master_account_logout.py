...
class TestEwalletClientExecuteActionMasterAccountLogout(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core = ewallet_client.EWalletClientCore(config_file=config_file)
        ...
        setup_values = cls.core.set_values(
            'RequestSessionToken',
            **{
    ...
    def test_ewcc_set_core_execute_action_master_account_logout_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action MasterAccountLogout -')
        execute = self.core.execute('MasterAccountLogout')
        print(
            "[ I ]: core.execute('MasterAccountLogout') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
