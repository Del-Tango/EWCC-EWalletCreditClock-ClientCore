...
class TestEwalletClientExecuteActionViewTimeSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewTimeSheet',
    ...
    def test_ewcc_set_core_execute_action_view_time_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewTimeSheet -')
        execute = self.core.execute('ViewTimeSheet')
        print(
            "[ I ]: core.execute('ViewTimeSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
