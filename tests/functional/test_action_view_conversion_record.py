...
class TestEwalletClientExecuteActionViewConversionRecord(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'ConvertCreditsToClock', 'ViewConversionRecord',
                'ViewConversionSheet', 'CreateMaster', 'AcquireMaster',
    ...
    def test_ewcc_set_core_execute_action_view_conversion_record_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewConversionRecord -')
        execute = self.core.execute('ViewConversionRecord')
        print(
            "[ I ]: core.execute('ViewConversionRecord') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
