...
class TestEwalletClientExecuteActionCreateTransferSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateTransferSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_transfer_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateTransferSheet -')
        execute = self.core.execute('CreateTransferSheet')
        print(
            "[ I ]: core.execute('CreateTransferSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
