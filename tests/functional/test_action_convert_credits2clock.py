...
class TestEwalletClientExecuteActionConvertCreditsToClock(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'ConvertCreditsToClock', 'CreateMaster', 'AcquireMaster',
    ...
    def test_ewcc_set_core_execute_action_convert_credits2clock_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ConvertCreditsToClock -')
        execute = self.core.execute('ConvertCreditsToClock')
        print(
            "[ I ]: core.execute('ConvertCreditsToClock') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
        ...
        self.assertTrue(isinstance(execute.get('converted_credits'), int))
