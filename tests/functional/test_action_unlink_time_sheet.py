...
class TestEwalletClientExecuteActionUnlinkTimeSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.time_sheet = int() if not clock_data else \
            cls.response['clock_data']['time_sheet']
    ...
    def tearDownClass(cls):
        ...
        create_sheet = cls.core.execute('CreateTimeSheet')
    ...
    def test_ewcc_set_core_execute_action_unlink_time_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action UnlinkTimeSheet -')
        execute = self.core.execute('UnlinkTimeSheet')
        print(
            "[ I ]: core.execute('UnlinkTimeSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
