...
class TestEwalletClientExecuteActionCreateConversionSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateConversionSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_create_conversion_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateConversionSheet -')
        execute = self.core.execute('CreateConversionSheet')
        print(
            "[ I ]: core.execute('CreateConversionSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
