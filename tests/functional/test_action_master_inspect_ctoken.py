...
class TestEwalletClientExecuteActionMasterInspectCToken(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'MasterAccountLogin', 'AcquireMaster', 'InspectCToken',
                'MasterUnlinkAccount'
            ]
        )
        ...
        cls.core.set_values(
            ...
            **{
                'client_id': cls.client_id.get('client_id'),
                'session_token': cls.session_token.get('session_token'),
                'ctoken': cls.client_id.get('client_id'),
            }
        )
    ...
    def test_ewcc_set_core_execute_action_master_inspect_ctoken_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action InspectCToken -')
        execute = self.core.execute('InspectCToken')
        print(
            "[ I ]: core.execute('InspectCToken') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
