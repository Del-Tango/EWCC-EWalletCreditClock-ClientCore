...
class TestEwalletClientExecuteActionCreateCreditClock(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        setup_handlers = cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'CreateCreditClock',
    ...
    def test_ewcc_set_core_execute_action_create_credit_clock_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action CreateCreditClock -')
        execute = self.core.execute('CreateCreditClock')
        print(
            "[ I ]: core.execute('CreateCreditClock') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
