    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'ViewConversionSheet', 'SupplyCredits', 'CreateMaster',
                'ConvertCreditsToClock', 'AcquireMaster', 'MasterAccountLogin',
                'MasterUnlinkAccount',
        ...
        view_sheet = cls.response = cls.core.execute('ViewConversionSheet')
