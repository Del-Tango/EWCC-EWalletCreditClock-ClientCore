...
class TestEwalletClientExecuteActionViewTransferSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewTransferSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_view_transfer_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewTransferSheet -')
        execute = self.core.execute('ViewTransferSheet')
        print(
            "[ I ]: core.execute('ViewTransferSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
