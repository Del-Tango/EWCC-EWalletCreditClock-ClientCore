...
class TestEwalletClientExecuteActionUnlinkTimeRecord(unittest.TestCase):
    ...
    def test_ewcc_set_core_execute_action_unlink_time_record_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action UnlinkTimeRecord -')
        execute = self.core.execute('UnlinkTimeRecord')
        print(
            "[ I ]: core.execute('UnlinkTimeRecord') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
