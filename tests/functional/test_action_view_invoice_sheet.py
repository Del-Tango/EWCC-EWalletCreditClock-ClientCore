...
class TestEwalletClientExecuteActionViewInvoiceSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core.setup_handlers(
            ...
            actions=[
                ...
                'AccountLogin', 'UnlinkAccount', 'ViewInvoiceSheet',
            ]
        )
    ...
    def test_ewcc_set_core_execute_action_view_invoice_sheet_functional(self):
        print('\n[ * ]: EWCC Subroutine Execute Action ViewInvoiceSheet -')
        execute = self.core.execute('ViewInvoiceSheet')
        print(
            "[ I ]: core.execute('ViewInvoiceSheet') \n"
            + "[ O ]: " + str(execute) + '\n'
        )
