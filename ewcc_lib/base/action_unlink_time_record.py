...
class UnlinkTimeRecord(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(UnlinkTimeRecord, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(UnlinkTimeRecord, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(UnlinkTimeRecord, self).execute(instruction_set)
