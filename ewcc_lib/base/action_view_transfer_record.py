...
class ViewTransferRecord(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(ViewTransferRecord, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ViewTransferRecord, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ViewTransferRecord, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ViewTransferRecord')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ViewTransferRecord, self).set_values(
