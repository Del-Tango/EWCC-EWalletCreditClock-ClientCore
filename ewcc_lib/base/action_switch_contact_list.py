...
class SwitchContactList(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(SwitchContactList, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(SwitchContactList, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(SwitchContactList, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('SwitchContactList')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(SwitchContactList, self).set_values(
