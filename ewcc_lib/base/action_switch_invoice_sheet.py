...
class SwitchInvoiceSheet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(SwitchInvoiceSheet, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'sheet_id': '<invoice-sheet type-int>',
        }
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(SwitchInvoiceSheet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(SwitchInvoiceSheet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('SwitchInvoiceSheet')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(SwitchInvoiceSheet, self).set_values(
