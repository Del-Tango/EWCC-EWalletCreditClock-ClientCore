...
class ConvertCreditsToClock(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(ConvertCreditsToClock, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('ConvertCreditsToClock')
        return {
            'instruction_set': {
                "controller": "client",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ConvertCreditsToClock, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ConvertCreditsToClock, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ConvertCreditsToClock')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ConvertCreditsToClock, self).set_values(
