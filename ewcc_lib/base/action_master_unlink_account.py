...
class MasterUnlinkAccount(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(MasterUnlinkAccount, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'forced_removal': '<forces-flag type-bool>',
        }
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(MasterUnlinkAccount, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(MasterUnlinkAccount, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('MasterUnlinkAccount')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(MasterUnlinkAccount, self).set_values(
