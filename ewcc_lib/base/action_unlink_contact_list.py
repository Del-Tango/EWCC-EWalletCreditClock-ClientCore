...
class UnlinkContactList(ActionBase):
    ...
    def __init__(self, *args, **kwargs):
        res = super(UnlinkContactList, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(UnlinkContactList, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(UnlinkContactList, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('UnlinkContactList')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(UnlinkContactList, self).set_values(
