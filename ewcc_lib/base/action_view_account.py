...
class ViewAccount(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(ViewAccount, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ViewAccount, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ViewAccount, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ViewAccount')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ViewAccount, self).set_values(
