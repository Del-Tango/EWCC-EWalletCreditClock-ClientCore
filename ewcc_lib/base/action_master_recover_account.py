...
class MasterRecoverAccount(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(MasterRecoverAccount, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('MasterRecoverAccount')
        return {
            'instruction_set': {
                "controller": "master",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(MasterRecoverAccount, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(MasterRecoverAccount, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('MasterRecoverAccount')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(MasterRecoverAccount, self).set_values(
