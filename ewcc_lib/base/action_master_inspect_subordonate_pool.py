...
class MasterInspectSubPool(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(MasterInspectSubPool, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('MasterInspectSubPool')
        return {
            'instruction_set': {
                "controller": "master",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(MasterInspectSubPool, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(MasterInspectSubPool, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('MasterInspectSubPool')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(MasterInspectSubPool, self).set_values(
