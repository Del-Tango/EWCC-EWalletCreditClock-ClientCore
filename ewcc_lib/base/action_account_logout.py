...
class AccountLogout(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(AccountLogout, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(AccountLogout, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(AccountLogout, self).execute(instruction_set)
