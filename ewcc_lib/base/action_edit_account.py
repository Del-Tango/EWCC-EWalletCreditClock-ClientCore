...
class EditAccount(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(EditAccount, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(EditAccount, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(EditAccount, self).execute(instruction_set)
