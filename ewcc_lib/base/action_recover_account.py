...
class RecoverAccount(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(RecoverAccount, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(RecoverAccount, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(RecoverAccount, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('RecoverAccount')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(RecoverAccount, self).set_values(
