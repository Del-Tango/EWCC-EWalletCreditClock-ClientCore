...
class ViewLogoutRecords(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(ViewLogoutRecords, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ViewLogoutRecords, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ViewLogoutRecords, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ViewLogoutRecords')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ViewLogoutRecords, self).set_values(
