...
class ViewContactRecord(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(ViewContactRecord, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ViewContactRecord, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ViewContactRecord, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ViewContactRecord')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ViewContactRecord, self).set_values(
