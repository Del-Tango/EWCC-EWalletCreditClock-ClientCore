...
class CreateCreditEWallet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(CreateCreditEWallet, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(CreateCreditEWallet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(CreateCreditEWallet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('CreateCreditEWallet')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(CreateCreditEWallet, self).set_values(
