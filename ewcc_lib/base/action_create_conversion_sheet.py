...
class CreateConversionSheet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(CreateConversionSheet, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('CreateConversionSheet')
        return {
            'instruction_set': {
                "controller": "client",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(CreateConversionSheet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(CreateConversionSheet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('CreateConversionSheet')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(CreateConversionSheet, self).set_values(
