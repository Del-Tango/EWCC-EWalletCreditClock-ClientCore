...
class CreateInvoiceSheet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(CreateInvoiceSheet, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(CreateInvoiceSheet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(CreateInvoiceSheet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('CreateInvoiceSheet')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(CreateInvoiceSheet, self).set_values(
