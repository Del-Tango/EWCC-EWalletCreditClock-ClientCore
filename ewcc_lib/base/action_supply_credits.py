...
class SupplyCredits(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(SupplyCredits, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'cost': '<price-in-currency type-float>',
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(SupplyCredits, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(SupplyCredits, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('SupplyCredits')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(SupplyCredits, self).set_values(
