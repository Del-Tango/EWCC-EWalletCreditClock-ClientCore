...
class CreateCreditClock(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(CreateCreditClock, self).__init__(*args, **kwargs)
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(CreateCreditClock, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(CreateCreditClock, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('CreateCreditClock')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(CreateCreditClock, self).set_values(
