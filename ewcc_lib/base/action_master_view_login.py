...
class MasterViewLoginRecords(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(MasterViewLoginRecords, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('MasterViewLoginRecords')
        return {
            'instruction_set': {
                "controller": "master",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(MasterViewLoginRecords, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(MasterViewLoginRecords, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('MasterViewLoginRecords')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(MasterViewLoginRecords, self).set_values(
