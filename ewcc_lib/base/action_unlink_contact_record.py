...
class UnlinkContactRecord(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(UnlinkContactRecord, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'record_id': '<contact-record type-int>',
        }
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(UnlinkContactRecord, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(UnlinkContactRecord, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('UnlinkContactRecord')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(UnlinkContactRecord, self).set_values(
