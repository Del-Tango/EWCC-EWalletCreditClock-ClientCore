...
class UnlinkConversionSheet(ActionBase):

    def __init__(self, *args, **kwargs):
        res = super(UnlinkConversionSheet, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('UnlinkConversionSheet')
        return {
            'instruction_set': {
                "controller": "client",
                "ctype": "action",
    ...
    def fetch_resource_key_map(self):
        ...
        return {
            ...
            'list_id': '<conversion-sheet type-int>',
        }
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(UnlinkConversionSheet, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(UnlinkConversionSheet, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('UnlinkConversionSheet')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(UnlinkConversionSheet, self).set_values(
