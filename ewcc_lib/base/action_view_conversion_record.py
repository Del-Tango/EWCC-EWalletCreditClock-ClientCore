...
class ViewConversionRecord(ActionBase):
    ...
    def __init__(self, *args, **kwargs):
        res = super(ViewConversionRecord, self).__init__(*args, **kwargs)
    ...
    def fetch_resource_purge_map(self):
        log.debug('ViewConversionRecord')
        return {
            'instruction_set': {
                "controller": "client",
                "ctype": "action",
    ...
    def purge(self, *args, **kwargs):
        ...
        return super(ViewConversionRecord, self).purge(
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(ViewConversionRecord, self).execute(instruction_set)

    def set_values(self, value_set, *args, **kwargs):
        log.debug('ViewConversionRecord')
        valid_keys = list(self.fetch_resource_key_map().keys())
        return super(ViewConversionRecord, self).set_values(
